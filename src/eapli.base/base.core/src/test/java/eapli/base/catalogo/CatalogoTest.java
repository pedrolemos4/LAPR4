...
public class CatalogoTest {
    ...
    public void testSameAs2() {
        ...
        Object other = new Catalogo(new Titulo("Test"),colaborador,new DescricaoCompletaCatalogo("Descrição Completa"),
                new DescricaoBreve("Descricao Breve"),new Icone("Icone"),new ArrayList<>(), new Criticidade(new Etiqueta("Etiqueta2"), new Escala(3), new Designacao("Name2"), new Objetivo(15,11,18,11), new Cor(13,13,13)));
    ...
    public void testEquals1() {
        ...
        Colaborador colaborador = new Colaborador(new MecanographicNumber(123456),new ShortName("Robert"),new FullName("Robert De Niro Dos Santos Afonso")
                ...
                ,EmailAddress.valueOf("exemplo@examplo.com"),new HashSet<>());
        Object other = new Catalogo(new Titulo("Test"),colaborador,new DescricaoCompletaCatalogo("Descrição Completa"),
                new DescricaoBreve("Descricao Breve"),new Icone("Icone"),new ArrayList<>(), new Criticidade(new Etiqueta("Etiqueta2"), new Escala(3), new Designacao("Name2"), new Objetivo(12,11,12,11), new Cor(13,13,13)));
    ...
    public void testToString1() {
        ...
        Catalogo instance = new Catalogo(new Titulo("Test"),colaborador,new DescricaoCompletaCatalogo("Descricao Completa"),
                new DescricaoBreve("Descricao Breve"),new Icone("Icone"),new ArrayList<>(), new Criticidade(new Etiqueta("Etiqueta2"), new Escala(3), new Designacao("Name2"), new Objetivo(13,11,13,11), new Cor(13,13,13)));
