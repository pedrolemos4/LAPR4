...
public class AtividadeManualTest extends TestCase {
    ...
    public void testToString() {
        ...
        listaAtributosFormulario2.add(new Atributo(new Variavel("Nome Completo"),new Label("Label do nome completo"), TipoDados.STRING,Obrigatoriedade.OPCIONAL,new DescricaoAjuda("ola"),null));
        listaAtributosFormulario2.add(new Atributo(new Variavel("Idade"),new Label("Label da idade"), TipoDados.STRING,Obrigatoriedade.OPCIONAL,new DescricaoAjuda("ola"),null));
        ...
        String expResult = "AtividadeManual{colab=null, equipa=[Equipa\n" +
                "Codigo: e1 Acronimo: EQP1 Designacao: desig1 Tipo: TipoEquipa{, codigoUnico=t1, designacao=tipo1, cor=Cor: red=10, green=20, blue=30}], decisao=APROVADO, comentario=Comentario{coment='comentario'}, formulario=null; Formulario1; [Nome Completo; Label do nome completo; ola; STRING; OPCIONAL, Idade; Label da idade; ola; STRING; OPCIONAL]}";
