...
public class FluxoRequest extends ServicosRhRequest {

    private final String servicoId;
    private final int userid;

    public FluxoRequest(final SolicitarServicoController controller, final String request, final String servicoId,
                        final String user){
